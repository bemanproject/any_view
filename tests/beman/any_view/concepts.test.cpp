...
TEST(ConceptsTest, iterator_concept) {
    ...
    static_assert(std::ranges::input_range<any_view<int, sized>>);
    static_assert(not std::ranges::forward_range<any_view<int, sized>>);
    static_assert(std::ranges::input_range<any_view<int, borrowed>>);
    static_assert(not std::ranges::forward_range<any_view<int, borrowed>>);
    static_assert(std::ranges::input_range<any_view<int, borrowed>>);
    static_assert(not std::ranges::forward_range<any_view<int, borrowed>>);
    static_assert(std::ranges::input_range<any_view<int, copyable>>);
    static_assert(not std::ranges::forward_range<any_view<int, copyable>>);
}
